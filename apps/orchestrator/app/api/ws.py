...
# Protocolo (solo texto, sin audio todavía — ver docs/ARCHITECTURE.md):
#   cliente -> servidor: {"tipo": "user_message", "texto": str}
#                        {"tipo": "confirmacion_respuesta", "id": str, "aprobado": bool}
    ...
    try:
        while True:
            ...
            try:
                ...
                if contexto:
                    messages.append(
                        {"role": "system", "content": f"Contexto relevante del vault:\n\n{contexto}"}
                    )
